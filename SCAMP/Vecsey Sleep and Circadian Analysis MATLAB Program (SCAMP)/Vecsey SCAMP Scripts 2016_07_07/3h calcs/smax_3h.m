function [h]= smax_3h(start,final,file1,Genotype1,file2,Genotype2,file3,Genotype3,file4,Genotype4)
...
ylabel({'Maximum Duration (min)'},'FontSize',12,'FontWeight','bold')
%line(1:length (h),[0])
...
%xlabel(xname,'FontSize',12,'FontWeight','bold')
ylabel({'Maximum Duration (min)'},'FontSize',12,'FontWeight','Normal')
%line(1:length (h),[0])
